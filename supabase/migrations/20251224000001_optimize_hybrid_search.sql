-- Optimization for Hybrid Search
-- Uses UNION to combine FTS and Similarity search efficiently, preventing Seq Scan on large tables.
-- Also handles empty search term separately to avoid unnecessary scoring.
